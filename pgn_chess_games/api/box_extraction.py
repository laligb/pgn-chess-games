...
def box_extraction(img_for_box_extraction_path, cropped_dir_path):
    ...
    # For Debugging
    # Enable this lines to see verticle and horizontal lines in the image which is used to find boxes
    ...
    print("Deleting temporary files from images/ ...")
...
if __name__ == "__main__":
    ...
    box_extraction("011_0.png", "prediction/")
